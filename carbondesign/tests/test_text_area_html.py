...
<svg focusable="false" preserveAspectRatio="xMidYMid meet"
  ...
  <path d="M7.5,4h1v5h-1C7.5,9,7.5,4,7.5,4z M8,12.2c-0.4,0-0.8-0.4-0.8-0.8s0.3-0.8,0.8-0.8	c0.4,0,0.8,0.4,0.8,0.8S8.4,12.2,8,12.2z" data-icon-path="inner-path" opacity="0"></path>
    ...
    <textarea name="text_missing" cols="50" rows="4" placeholder="Placeholder text." class="bx--text-area bx--text-area--v2 bx--text-area--invalid" required id="id_text_missing">
</textarea>
  </div>
...
<svg focusable="false" preserveAspectRatio="xMidYMid meet"
  ...
  <path d="M7.5,4h1v5h-1C7.5,9,7.5,4,7.5,4z M8,12.2c-0.4,0-0.8-0.4-0.8-0.8s0.3-0.8,0.8-0.8	c0.4,0,0.8,0.4,0.8,0.8S8.4,12.2,8,12.2z" data-icon-path="inner-path" opacity="0"></path>
    ...
    <textarea name="text_missing" cols="50" rows="4" placeholder="Placeholder text." class="bx--text-area bx--text-area--v2 bx--text-area--light bx--text-area--invalid" required id="id_text_missing">
</textarea>
  </div>
  <div class="bx--form-requirement">
    <div class="bx--form-requirement__title">This field is required.</div>
