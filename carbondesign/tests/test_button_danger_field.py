...
"""
        expected = """
<button class="bx--btn bx--btn--danger bx--btn--field" type="button" aria-label="danger">
  Button
</button>
"""
...
"""
        expected = """
<button class="bx--btn bx--btn--danger bx--btn--field" type="button" disabled="disabled" aria-label="danger">
  Button
</button>
"""
        rendered = compare_template(template, expected)
