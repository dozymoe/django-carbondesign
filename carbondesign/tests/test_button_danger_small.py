...
"""
        expected = """
<button class="bx--btn bx--btn--danger bx--btn--sm" aria-label="danger" type="button">
  Button
</button>
"""
...
"""
        expected = """
<button class="bx--btn bx--btn--danger bx--btn--sm" aria-label="danger" disabled="disabled" type="button">
  Button
</button>
"""
        rendered = compare_template(template, expected)
