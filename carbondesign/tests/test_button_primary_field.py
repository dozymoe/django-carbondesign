...
class ButtonPrimaryFieldTest(SimpleTestCase):
    maxDiff = None

    def test_default(self):
        template = """
{% load carbondesign %}
{% Button field=True variant="primary" type="button" %}
  Button
{% endButton %}
"""
        expected = """
...
"""
    ...
    def test_disabled(self):
        template = """
{% load carbondesign %}
{% Button field=True variant="primary" type="button" disabled=True %}
  Button
{% endButton %}
"""
        expected = """
<button class="bx--btn bx--btn--primary bx--btn--field" type="button" disabled="disabled">
  Button
</button>
"""
        rendered = compare_template(template, expected)
