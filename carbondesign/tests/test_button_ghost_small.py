...
class ButtonGhostSmallTest(SimpleTestCase):
    maxDiff = None

    def test_default(self):
        template = """
{% load carbondesign %}
{% Button small=True variant="ghost" type="button" %}
  Button
{% endButton %}
"""
        expected = """
...
"""
    ...
    def test_disabled(self):
        template = """
{% load carbondesign %}
{% Button small=True variant="ghost" type="button" disabled=True %}
  Button
{% endButton %}
"""
        expected = """
<button class="bx--btn bx--btn--ghost bx--btn--sm" type="button" disabled="disabled">
  Button
</button>
"""
        rendered = compare_template(template, expected)
