...
class ButtonDangerTest(SimpleTestCase):
    maxDiff = None

    def test_default(self):
        template = """
{% load carbondesign %}
{% Button variant="danger" label="danger" type="button" %}
  Button
{% endButton %}
"""
        expected = """
<button class="bx--btn bx--btn--danger" aria-label="danger" type="button">
  Button
</button>
"""
    ...
    def test_disabled(self):
        template = """
{% load carbondesign %}
{% Button variant="danger" label="danger" type="button" disabled=True %}
  Button
{% endButton %}
"""
        expected = """
<button class="bx--btn bx--btn--danger" aria-label="danger" disabled="disabled" type="button">
  Button
</button>
"""
        rendered = compare_template(template, expected)
